...
namespace GUI 
{
    ...
    void BoolInfoWidget::on_pushButton_Clear_clicked()
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::on_pushButton_Add_clicked()
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::slotCellTableClicked(int row, int column)
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::slotEditNameStart()
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::slotEditNameFinish()
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::slotFaceWidgetOkClicked()
    {
        CompFaceGroupSelectWidget* widget = dynamic_cast<CompFaceGroupSelectWidget*>(sender());
        if (widget == nullptr) return;
        //执行选择结束事件
    ...
    void BoolInfoWidget::slotFaceWidgetCancelClicked()
    {
    ...
    void BoolInfoWidget::slotFaceWidgetDeleteClicked()
    {
        if (_obj == nullptr)return;
        Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
        if (commanger == nullptr)return;
    ...
    //void BoolInfoWidget::updateTableTitle()
    //{
    //    if (_obj == nullptr)return;
    //    Interface::FITKGeoComponentManager* commanger = _obj->getShapeAgent()->getGeoComponentManager();
    //    if (commanger == nullptr)return;
    ...
    void BoolInfoWidget::initTableWidget()
    {
    ...
    void BoolInfoWidget::setAllFaceGroupSelect(bool type)
    {
        for (int i = 0; i < _ui->tableWidget->rowCount(); i++) {
            CompFaceGroupSelectWidget* widget = dynamic_cast<CompFaceGroupSelectWidget*>(_ui->tableWidget->cellWidget(i, 0));
            if (widget == nullptr)return;
    ...
    void BoolInfoWidget::updateFaceWidgetCurrentPos()
    {
        for (int i = 0; i < _ui->tableWidget->rowCount(); i++) {
            CompFaceGroupSelectWidget* widget = dynamic_cast<CompFaceGroupSelectWidget*>(_ui->tableWidget->cellWidget(i, 0));
            if (widget == nullptr)return;
    ...
    void BoolInfoWidget::clearGraphHight()
    {
        //退出选择模式
    ...
    void BoolInfoWidget::clearTableWidget()
    {
        for (int i = 0; i < _ui->tableWidget->rowCount(); i++) {
