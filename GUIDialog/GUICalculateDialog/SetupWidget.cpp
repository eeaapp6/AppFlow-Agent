...
namespace GUI
{
    ...
    QString SetupWidget::typeToName(Interface::FITKOFSolverEnum::FITKOFSolverType type)
    {
        QString name = "";
        switch (type) {
        case Interface::FITKOFSolverEnum::FITKOFSolverType::NoneSolver: break;
        case Interface::FITKOFSolverEnum::FITKOFSolverType::SIMPLE: name = tr("SIMPLE"); break;
        case Interface::FITKOFSolverEnum::FITKOFSolverType::Inter: name = tr("Inter"); break;
        }
        return name;
    }
    ...
    {
        _types.append(Interface::FITKOFSolverEnum::SIMPLE);
        _types.append(Interface::FITKOFSolverEnum::Inter);
    }
